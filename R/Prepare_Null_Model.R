                                ...
                                threadNum = 8)
{
  ...
  outFile = paste0(tempDir, "/Plink-",PlinkName,"-chr-",chrParallel,"-minMaf-",minMafGRM,"-maxMissing-",maxMissingGRM)
...
#' @param PlinkFile a path to Plink files. The current version (gcta_1.93.1beta) of gcta software does not support difference prefix names for bim, bed and fam files. 
#' @param nPartsGRM GCTA software can split subjects to multiple parts. For UK-Biobank analysis, it is recommanded to use 250 parts. This should be consistent to the input of getSparseGRMParallel().
